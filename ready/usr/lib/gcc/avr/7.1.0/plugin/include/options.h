...
#define MASK_SKIP_BUG (1U << 10)
#define MASK_TINY_STACK (1U << 11)
...
enum opt_code
{
  ...
  OPT_morder1 = 1163,                        /* -morder1 */
  OPT_morder2 = 1164,                        /* -morder2 */
  OPT_mpmem_wrap_around = 1165,              /* -mpmem-wrap-around */
  OPT_mrelax = 1166,                         /* -mrelax */
  OPT_mrmw = 1167,                           /* -mrmw */
  OPT_mskip_bug = 1168,                      /* -mskip-bug */
  OPT_msp8 = 1169,                           /* -msp8 */
  OPT_mstrict_X = 1170,                      /* -mstrict-X */
  OPT_mtiny_stack = 1171,                    /* -mtiny-stack */
  OPT_n = 1172,                              /* -n */
  ...
  OPT_nodevicelib = 1178,                    /* -nodevicelib */
